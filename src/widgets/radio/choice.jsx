...
const Choice = React.createClass({
    ...
    render: function() {
        ...
        const descriptionCheckboxClassname = "checkbox " +
            css(styles.mobile && sharedStyles.perseusInteractive,
                styles.mobile && styles.mobileDescriptionCheckbox);
        ...
        >
            ...
            <div className="description">
                <div className="checkbox-and-option">
                    <span className={descriptionCheckboxClassname}>
                ...
                {this.props.showClue &&
                    <div className={"perseus-radio-clue " + css(styles.clue)}>
                        {this.props.clue}
                    </div>}
            </div>
        </label>;
